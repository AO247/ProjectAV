...
P2F main(V2P pixel)
{
    ...
    float3 local2 = Desaturate(Texture1.Sample(TexSampler, pixel.uv).rgb, float3(0.300000f,0.590000f,0.110000f), 1.000000f);
    result.fragment = CombineRGBWithAlpha(local2, Texture1.Sample(TexSampler, pixel.uv).a);
    // END GENERATED CODE

...
RenderTarget::RenderTarget(Graphics& gfx, UINT width, UINT height, DXGI_FORMAT format) // Added format parameter
    :
    width(width),
    height(height)
{
    ...
    textureDesc.Format = format; // Use the passed-in format
    ...
    srvDesc.Format = textureDesc.Format; // Use the same format for SRV
    ...
    rtvDesc.Format = textureDesc.Format; // Use the same format for RTV

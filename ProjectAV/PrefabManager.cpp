...
Node* PrefabManager::InstantiateIsland1(Node* parentNode, float locX, float locY, float locZ, float scale) const {
...
Node* PrefabManager::InstantiateIsland2(Node* parentNode, float locX, float locY, float locZ, float scale) const {
